...
const config: CheatsheetConfig<GitCommandCategory, GitCommand> = {
  categoryOrder: GIT_CATEGORY_ORDER,
  getGroupedData: getGitCommandsByCategory,
  categoryColors: CATEGORY_COLORS,
  translationPrefix: "gitCommands",
