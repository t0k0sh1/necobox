  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setError(data.error || t('error.convertFailed'));
      }
    } catch (err) {
      setError(t('error.processFailed'));
      console.error(err);
    } finally {
      setLoading(false);
    }
        ...
        <div className="space-y-6 bg-white dark:bg-black rounded-lg p-6 border mt-6">
          ...
          <div className="space-y-4">
            ...
            <Button
              ...
              className="w-full"
            >
              {loading ? tCommon('converting') : tCommon('convert')}
            </Button>
          </div>
          ...
          {result && (
            <div className="space-y-4">
              ...
              >
                ...
                {copied ? tCommon('copied') + "!" : t('copyToClipboard')}
              </Button>
            </div>
          )}
        </div>
