...
export default function RandomIntegerPage() {
  const t = useTranslations('randomInteger');
              ...
              <div className="flex gap-4">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="w-4 h-4"
                  />
                  <span>{t('uniformDistribution')}</span>
                </label>
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    type="radio"
                    ...
                    className="w-4 h-4"
                  />
                  <span>{t('normalDistribution')}</span>
                </label>
              </div>
            </div>
          ...
          {results.length > 0 && (
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <h2 className="text-lg font-semibold">{t('generatedValues')}</h2>
                <Button
                  variant="outline"
                  size="sm"
