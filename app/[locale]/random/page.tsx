...
export default function RandomPasswordPage() {
  ...
  // Check if "no repeat" is available
  ...
  const getPasswordStrength = () => {
    ...
    if (passwordLength < 12 || characterTypes <= 2) {
      return {
        level: t('strength.weak'),
        description: t('strength.weakDescription'),
        textColor: "text-red-600",
        bgColor: "bg-red-50 dark:bg-red-900/20",
      };
    } else if (passwordLength >= 16 && characterTypes >= 3) {
      return {
        level: t('strength.strong'),
        description: t('strength.strongDescription'),
        textColor: "text-green-600",
        bgColor: "bg-green-50 dark:bg-green-900/20",
      };
    } else {
      return {
        level: t('strength.moderate'),
        description: t('strength.moderateDescription'),
  ...
  // Auto-disable noRepeat if conditions not met
  useEffect(() => {
        ...
        <div className="space-y-6 bg-white dark:bg-black rounded-lg p-6 border mt-6">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              ...
              <span className="text-lg font-medium">{length} {tCommon('chars')}</span>
            </div>
            <Slider
              value={[length]}
          ...
          <div className="space-y-3">
            ...
            {symbols && (
              <div className="ml-7 space-y-2 border-l pl-4">
                <div className="text-sm font-medium mb-2">{t('selectSymbols')}</div>
            ...
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              <div className="relative group">
                ...
                <div className="absolute left-0 top-6 w-80 p-3 bg-gray-900 text-white text-xs rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-10 pointer-events-none">
                  <div className="font-semibold mb-2">{t('excludeSimilarTooltip.title')}</div>
